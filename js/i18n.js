...
export const dict = {
  ru: {
    ...
    scanTimeoutHint: "Скан не завершился — нажмите «Обновить» или подождите и обновите страницу",
    debankReference: "Оценка DeBank: {debank} · загружено позиций: {computed}",
    ...
    lpStepDebank: "Etherscan · кошелёк и токены",
  ...
  en: {
    ...
    debankReference: "DeBank estimate: {debank} · positions loaded: {computed}",
    ...
    lpStepDebank: "Etherscan · wallet & tokens",
